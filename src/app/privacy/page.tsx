  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6 space-y-4 text-gray-700">
          <p>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
          ...
          <div className="space-y-3 text-gray-700">
            <p>
              <strong>Account information.</strong> If you create an account, we collect the email
            ...
            <p>
              <strong>Study activity.</strong> If you&apos;re signed in, your quiz answers, correct/incorrect
            ...
            <p>
              <strong>What we don&apos;t collect.</strong> QRZ Ready does not use analytics or advertising
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">3. Who we share it with</h2>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
          ...
          <div className="space-y-3 text-gray-700">
            <p>
              ...
              time from your{' '}
              <Link href="/account" className="text-blue-600 hover:text-blue-800">Account page</Link>{' '}
            ...
            <p>
              <strong>If you&apos;re in the EU/EEA or UK (GDPR):</strong> our legal basis for processing
            ...
            <p>
              <strong>If you&apos;re a California resident (CCPA/CPRA):</strong> we do not sell or share
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">6. Data retention &amp; security</h2>
          <p className="text-gray-700">
