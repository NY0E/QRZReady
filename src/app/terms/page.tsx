  ...
  return (
    <div className="min-h-screen bg-bg">
      <div className="max-w-3xl mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-mono font-medium text-ink mb-2">Terms of Service</h1>
          <p className="text-ink-mid">Last updated August 24, 2026</p>
        </div>

        <div className="bg-surface rounded-lg border border-border p-6 mb-6 text-ink-mid">
          <p>
        ...
        <div className="bg-surface rounded-lg border border-border p-6 mb-6">
          <h2 className="text-xl font-mono font-medium text-ink mb-4">1. Who can use QRZ Ready</h2>
        ...
        <div className="bg-surface rounded-lg border border-border p-6 mb-6">
          <h2 className="text-xl font-mono font-medium text-ink mb-4">2. No warranty on exam content</h2>
        ...
        <div className="bg-surface rounded-lg border border-border p-6 mb-6">
          <h2 className="text-xl font-mono font-medium text-ink mb-4">3. Your account</h2>
          <p className="text-ink-mid">
            ...
            See our{' '}
            <Link href="/privacy" className="text-amber hover:text-amber/80 transition-colors">Privacy Policy</Link>{' '}
        ...
        <div className="bg-surface rounded-lg border border-border p-6 mb-6">
          <h2 className="text-xl font-mono font-medium text-ink mb-4">4. Acceptable use</h2>
        ...
        <div className="bg-surface rounded-lg border border-border p-6 mb-6">
          <h2 className="text-xl font-mono font-medium text-ink mb-4">5. Limitation of liability</h2>
          <p className="text-ink-mid">
        ...
        <div className="bg-surface rounded-lg border border-border p-6 mb-6">
          <h2 className="text-xl font-mono font-medium text-ink mb-4">6. Changes to the service or terms</h2>
          <p className="text-ink-mid">
        ...
        <div className="bg-surface rounded-lg border border-border p-6 mb-6">
          <h2 className="text-xl font-mono font-medium text-ink mb-4">7. Governing law</h2>
          <p className="text-ink-mid">
        ...
        <div className="bg-surface rounded-lg border border-border p-6 mb-6">
          <h2 className="text-xl font-mono font-medium text-ink mb-4">8. Contact</h2>
          <p className="text-ink-mid">
